                ...
                [
                    ...
                    dbc.Col(
                        [
                            ...
                            field("Phase III Success Rate", number_input("phase-iii-success", a["phase_iii_success"], 0.5)),
                            field("Approval Success Rate", number_input("approval-success", a["approval_success"], 0.5)),
                        ],
                        lg=3,
                        md=6,
                    ),
